...
class TestStep(unittest.TestCase):
    ...
    def test_variable_substitution(self):
        ...
        step_text = s.get_text(dict(ROOT_DIR='/tmp/root', SOURCE_DIR='/tmp/src'))
    ...
    def test_pattern_rule_conversion(self):
        ...
        declaration_line, command_line = s.get_text().split('\n')[:2]
    ...
    def test_target_directories_created_but_only_once(self):
        ...
        commands = unformat(s.get_text()).split('\n')[1:]
